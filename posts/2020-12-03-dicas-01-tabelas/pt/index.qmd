...
[^1]: Outros pacotes que permitem criar tabelas são: [DT](https://rstudio.github.io/DT/), [reactable](https://glin.github.io/reactable/index.html), [flextable](https://davidgohel.github.io/flextable/articles/overview.html) e [kableExtra](https://cran.r-project.org/web/packages/kableExtra/vignettes/awesome_table_in_html.html). [Essa página](https://rfortherestofus.com/2019/11/how-to-make-beautiful-tables-in-r/) também apresenta materiais muito ricos sobre elaboração de tabelas!
